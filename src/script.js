...
gui.add(Cube.material, 'metalness').min(0).max(1).step(0.01)
gui.add(Cube.material, 'roughness').min(0).max(1).step(0.01)
gui.add(Cube.material, 'reflectivity').min(0).max(1).step(0.01)
